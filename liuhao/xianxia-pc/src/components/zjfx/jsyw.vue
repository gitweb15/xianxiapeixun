	...
	<div>
		...
		<div class="main">
			<div class="clear">
				<div class="left mainLeft">
					<div class="clear">
						<div class="left">
							<h4>今日业务量报表统计</h4>
							<div id="chart" class="chart" style="width: 500px;height:280px;"></div>
						</div>
				...
				<div class="left mainRight">
					<div class="clear">
						<h4 class="left gxqCss">今日业务量金额统计</h4>
					...
					<div id="chartliu" class="chart" style="width: 500px;height:280px;"></div>
				</div>
				<!-- rightMian-->
			</div>
			...
			<div class="botton">
				...
				<template>
					<el-table :data="tableData" style="width: 94%" height="400">
						<el-table-column fixed prop="date" label="排行">
						</el-table-column>
						<el-table-column prop="name" label="业务教师">
						</el-table-column>
						<el-table-column prop="liu" label="报班数量" sortable width="180">
						</el-table-column>
						<el-table-column prop="li" label="报班金额" sortable>
						</el-table-column>
						<el-table-column prop="l" label="排行" sortable>
						</el-table-column>
					</el-table>
				</template>
			</div>
		...
		methods: {
			moneySta() {
				...
				let option = {
					...
					color: ["#3a4b68", "#7687e8", "#34d4f1", "#262626", "#f22616", "#fc7a5c", "#3a4b68"]
				};
				myChart.setOption(option);
			},
			liu() {
				var myChart = echarts.init(document.getElementById("chartliu"));
				let option = {
					tooltip: {
						trigger: "item",
						formatter: function(data) {
