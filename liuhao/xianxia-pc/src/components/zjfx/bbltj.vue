      ...
      <div class="clear">
        <div class="left mainLeft">
          <div class="clear">
            <div class="left">
              <h4>报班统计</h4>
			  <div class="right btncss" style="position: relative;top: -40px;left: 200px;">
        ...
        <div class="left mainRight">
          <div class="clear">
            <h4 class="left gxqCss">本校区报班情况</h4>
			<div class="right btncss">
			  <el-button size="mini">本月</el-button>
			  <el-button size="mini">本周</el-button>
			  <el-button size="mini">本日</el-button>
			...
			<div style="position: relative;top: -350px;">
				<div class="left mainLeft">
				  <div class="clear">
				    <div class="left">
				      <h4>手机报班转校分析</h4>
					  <div class="right btncss" style="position: relative;top: -40px;">
					    <el-button size="mini">本月</el-button>
					    <el-button size="mini">本周</el-button>
					    <el-button size="mini">本日</el-button>
					  </div>
				...
				<div class="left mainRight">
				  ...
				  <div id="chartl" class="chart" style="width: 480px;height:240px;"></div>
				</div>
			</div>
        ...
        series: [
          {
            ...
            data: [
              { value: this.yewuVal, name: "自主报表" },
              { value: this.zizhuVal, name: "业务报表" }
            ]
          }
        ],
        color: ["#7687e8", "#3a4b68"]
	    ...
	    series: [
	      {
	        ...
	        data: [
	          { value: this.yewuVal1, name: "新课程购买" },
	          { value: this.zizhuVal1, name: "课程续费" }
	        ]
	      }
	    ],
	    color: ["#7687e8", "#3a4b68"]
