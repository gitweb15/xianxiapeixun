    ...
    <div class="main">
      <div class="clear">
        <div class="left mainLeft">
          <div class="clear">
            <div class="left">
              ...
              <div id="chart4" class="chart" style="width: 500px;height:380px;"></div>
            </div>
          </div>
          <!-- leftMian-->
        </div>
        <div class="left mainRight">
          ...
          <div id="chart" class="chart" style="width: 480px;height:380px;"></div>
        </div>
        <!-- rightMian-->
      </div>
    </div>
        ...
        series: [
          {
            ...
            data: [
              { value: this.yewuVal, name: "业务支付" },
              { value: this.zizhuVal, name: "手机支付" }
            ]
          }
        ],
        color: ["#7687e8", "#3a4b68"]
