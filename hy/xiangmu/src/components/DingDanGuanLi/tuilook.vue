<template>
	<div style='margin:0px 50px 0px 50px;'>
		 <div>
			  <router-link type="primary" to='/tuifei' tag='el-button' style="background: #0000FF;color: white;">退费完成</router-link> 
			   <router-link to='/tuifei' type="danger" tag='el-button' style="background-color: red;color: white;width: 10%;">取消</router-link>
		 </div>
