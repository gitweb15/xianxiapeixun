	...
	<div>
		...
		<div class="main" style="width:100%;">
			...
			<div class="main-tab">
				<el-table :data="tableData" style="width: 100%;" :header-cell-style="tableHeaderColor" :row-class-name="tableRowClassName">
					...
					<el-table-column prop="check3" label="操作" width="150">
						<router-link to='/zhuangxiaolook' style="color: #0000FF;" @click="dialogFormVisible = true">转校</router-link>
					</el-table-column>
				</el-table>
			...
			<el-dialog :visible.sync="dialogFormVisible">
				<el-form :model="form" title='原订单详情'>
				...
				<el-form :model="form" title='转校订单详情'>
						<el-form-item label="转校订单详情" :label-width="formLabelWidth" style="width:50%;margin-left: -20px; font-weight: bold;">
						</el-form-item>
						<el-form-item label="订单时间" :label-width="formLabelWidth" style="width:50%;margin-left: -40px;">
							<span>20190414</span>
						</el-form-item>
						<el-form-item label="业务教师" :label-width="formLabelWidth" style="width: 50%;float: right;margin-top: -60px;margin-right: 20px;">
							<span>无</span>
						...
						<el-form-item label="课程单价ID" :label-width="formLabelWidth" style="margin-left: -40px;">
							<span>120</span>
						</el-form-item>
						<el-form-item label="剩余课时" :label-width="formLabelWidth" style="width: 50%;float: right;margin-top: -60px;margin-right: 20px;">
							<span>12</span>
						</el-form-item>
						<el-form-item label="总价" :label-width="formLabelWidth" style="margin-left: -40px;">
							<span style="margin-right: 10px;">1400</span>
							<!-- <el-input v-model="form.name" autocomplete="off" pla"></el-input> -->
						</el-form-item>
						<el-form-item label="需补差价" :label-width="formLabelWidth" style="margin-left: -40px;">
							<span>240</span>
						</el-form-item>
						<el-form-item label="支付状态" :label-width="formLabelWidth" style="width: 50%;float: right;margin-top: -60px;margin-right: 20px;">
							<span>已支付</span>
						</el-form-item>
					</el-form>
			</el-dialog>
