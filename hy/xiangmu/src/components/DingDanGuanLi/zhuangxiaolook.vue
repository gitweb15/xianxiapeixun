<template>
	<div style='margin:0px 50px 0px 50px;'>
		 <div>
			  <router-link type="primary" to='/zhuangxiao' tag='el-button' style="background: #0000FF;color: white;">审核通过</router-link> 
			   <router-link to='/zhuangxiao' type="danger" tag='el-button' style="background-color: red;color: white;width: 10%;">审核完成</router-link>
		 </div>
		<el-form :model="form" title='原订单详情' style='border: 1px solid gainsboro;margin-top: 50px;'>
			<el-form-item label="原订单详情" :label-width="formLabelWidth" style="width:50%;margin-left: 20px; font-weight: bold;">
			</el-form-item>
			...
			<el-form-item label="支付状态" :label-width="formLabelWidth" style="width: 50%;float: right;margin-top: -60px;margin-right: 0px;">
				<span>已支付</span>
			</el-form-item>
