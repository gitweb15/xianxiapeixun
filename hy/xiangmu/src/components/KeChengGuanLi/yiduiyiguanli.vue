		...
		<div class="main" style="width:100%;">
			...
			<div class="main-tab">
				<el-table :data="tableData" style="width: 100%;" :header-cell-style="tableHeaderColor" :row-class-name="tableRowClassName">
					...
					<el-table-column prop="num" label="价格" width="120"></el-table-column>
					<el-table-column prop="check" label="学习中人数" width="120">
						<!-- <input type="checkbox" /> -->
					</el-table-column>
					<el-table-column prop="check1" label="状态" width="120"></el-table-column>
					<!-- <el-table-column prop="check2" label="订单总价" width="150"></el-table-column> -->
					<el-table-column prop="check3" label="操作" width="150">
						<span style="color: #0000FF;" @click="dialogFormVisible = true">编辑</span><span style="color: #0000FF;margin-left: 10px;">开课</span>
					</el-table-column>
				</el-table>
