        ...
        >
          ...
          <el-table-column label="操作" width="118">
            <template slot-scope="scope">
              ...
              >
                <span>课程原价：1500</span>
                <div style="margin: 15px 0;" class="clear">
                  <div class="left">活动价格：</div>
                  <div class="left" style="width:60%">
                    <el-input v-model="jia" placeholder="请输入活动课程价格" clearable></el-input>
                    <p style="color: red">注意设置价格则代表参加活动。</p>
                  </div>
                </div>
