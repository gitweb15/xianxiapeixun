        ...
        <el-col :span="16">
          <el-form :inline="true" :model="formInline" class="demo-form-inline">
            <el-form-item class="left">
              <el-button type="primary" size="small" @click.native="insert=true">新增用户</el-button>
              <el-button type="primary" size="small">导入Excel</el-button>
              <el-button type="text" size="small">Excel模板下载</el-button>
              <!-- 弹出层 -->
              <el-dialog title="新增用户" :visible.sync="insert" width="70%">
                <el-form :model="form" class="clear">
                  <el-form-item label="所在部门：" style="width:100%;text-align:left;padding-left: 45px;margin:10px 0;">
                    <el-input v-model="form.name" autocomplete="off" :disabled="true" placeholder="教育集团—部门一"></el-input>
                  </el-form-item>
                  <el-form-item label="姓名：" style="padding-left: 40px;margin:10px 0;">
                    <el-input v-model="form.name" autocomplete="off"></el-input>
                  </el-form-item>
                  <el-form-item label="联系方式：" style="margin:10px 0;">
                    <el-input v-model="form.name" autocomplete="off"></el-input>
                  </el-form-item>
                  <el-form-item label="性别：">
                    <el-select v-model="form.region" placeholder="请选择内容">
                      <el-option label="男" value="fu1"></el-option>
                      <el-option label="女" value="fu2"></el-option>
                    </el-select>
                  </el-form-item>
                </el-form>
