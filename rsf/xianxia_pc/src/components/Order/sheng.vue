<template>
	<div style='' class="appZ">
		 <div>
			  <router-link type="primary" to='/Order/zxgl' tag='el-button' style="background: #0000FF;color: white;">审核通过</router-link> 
			   <router-link to='/Order/zxgl' type="danger" tag='el-button' style="background-color: red;color: white;width: 10%;">取消</router-link>
		 </div>
		<el-form :model="form" title='订单详情' style='border: 1px solid gainsboro;margin-top: 50px;'>
			...
			<el-form-item label="退费方式" :label-width="formLabelWidth" style="margin-left: 40px;">
				<el-select>
					<el-option value="请选择退费方式">请选择退费方式</el-option>
					<el-option value="请选择退费方式">请选择退费方式</el-option>
				</el-select>
			</el-form-item>
		</el-form>
