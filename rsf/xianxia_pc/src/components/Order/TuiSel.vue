<template>
	<div style='' class="appZ">
		 <div>
			  <router-link type="primary" to='/Order/tfgl' tag='el-button' style="background: #0000FF;color: white;">退费完成</router-link> 
			   <router-link to='/Order/tfgl' type="danger" tag='el-button' style="background-color: red;color: white;width: 10%;">取消</router-link>
		 </div>
