  ...
  <div>
    ...
    <div class="main" style="width:100%;">
      ...
      <div class="main-tab">
        ...
        >
          <el-table-column prop="id" label="教师姓名" width="150"></el-table-column>
          <el-table-column prop="name" label="手机号码" width="200"></el-table-column>
          <el-table-column prop="xiaoQ" label="所在校区" width="120"></el-table-column>
          <el-table-column prop="grade" label="教师类型" width="120"></el-table-column>
          <el-table-column prop="Oprice" label="教学学段" width="150"></el-table-column>
