<template>
	<div id="contain">
		<div>
			<p><span style="border: 1px solid limegreen;background: limegreen;padding-left: 5px;"></span>班级课程试学管理</p>
		</div>
		<div style="margin-left: 50px;">
			<div class="header">
				<button @click="dialogFormVisible1 = true">新增活动</button>
			</div>
			<el-table ref="multipleTable" :data="tableData" class="select" tooltip-effect="dark" style="width:95%;background: red;"
			 @selection-change="handleSelectionChange">
				<el-table-column prop="no" label="序" width="120">
				</el-table-column>
				<el-table-column prop="name" label="试学名称" show-overflow-tooltip>
				</el-table-column>
				<el-table-column prop="xiaoqu" label="开始时间" show-overflow-tooltip>
				</el-table-column>
				<el-table-column prop="date" label="结束时间" show-overflow-tooltip>
				</el-table-column>
				<el-table-column prop="price" label="查看" show-overflow-tooltip>
					<span @click="dialogFormVisible = true" style="color: blue;">修改</span>
					<!-- <span style="padding-left: 10px;color: blue;" to='/click'>查看</span> -->
		...
		<!-- 新增 -->
		<el-dialog title="活动管理" :visible.sync="dialogFormVisible1">
		  <el-form :model="form">
			<el-form-item label="活动名称" :label-width="formLabelWidth" style="width: 10%;">
				<el-input v-model="form.name" autocomplete="off" placeholder="请输入内容" style="width: 200px;"></el-input>
			</el-form-item>
