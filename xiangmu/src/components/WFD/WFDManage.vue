    ...
    <div class="main" style="width:100%;">
      ...
      <div class="main-tab">
        ...
        >
          ...
          <el-table-column prop="Oprice" label="价格" width="150"></el-table-column>
          <el-table-column prop="can" label="学习中人数" width="120"></el-table-column>
          <el-table-column prop="Pprice" label="状态" width="120"></el-table-column>
